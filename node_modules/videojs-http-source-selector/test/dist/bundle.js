...
QUnit.test('the environment is sane', function (assert) {
  ...
  assert.strictEqual(typeof httpSourceSelector === 'undefined' ? 'undefined' : _typeof(httpSourceSelector), 'function', 'plugin is a function');
});
...
QUnit.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(_typeof(Player.prototype.httpSourceSelector), 'function', 'videojs-http-source-selector plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-http-source-selector'), 'the plugin adds a class to the player');
});
